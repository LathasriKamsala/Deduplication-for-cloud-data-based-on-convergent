    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article style2">
          <h2 class="style1">Uploading Data.. </h2>
            <p>&nbsp;</p>
          <div class="article">
...
<input type="hidden" name="fsize" value="<%=sourceFileSize %>" />
  <table width="560" border="0" align="center">
    <tr><input type="hidden" name="start" value="<%=start%>" />
      <td width="143" height="39" bgcolor="#FF0000"><span class="style3 style22"><em>File Name :- </em></span></td>
      <td width="407"><input name="t42" type="text" id="t42"
			value="<%= file %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style3 style22"><em>Block-1 </em></span></td>
    ...
    <tr>
      <td height="40" bgcolor="#FF0000"><span class="style3 style22"><em>MAC-1: </em></span></td>
      <td><input name="t1" type="text" id="t4"
			value="<%= h[1] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="41" bgcolor="#FF0000"><span class="style3 style22"><em>Block-2 </em></span></td>
    ...
    <tr>
      <td height="37" bgcolor="#FF0000"><span class="style3 style22"><em>MAC-2: </em></span></td>
      <td><input name="t2" type="text" id="t4"
			value="<%= h[2] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style3 style22"><em>Block-3 </em></span></td>
    ...
    <tr>
      <td height="41" bgcolor="#FF0000"><span class="style3 style22"><em>MAC-3: </em></span></td>
      <td><input name="t3" type="text" id="t4"
			value="<%= h[3]%>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="35" bgcolor="#FF0000"><span class="style3 style22"><em>Block-4 </em></span></td>
    ...
    <tr>
      <td height="42" bgcolor="#FF0000"><span class="style3 style22"><em>MAC-4: </em></span></td>
