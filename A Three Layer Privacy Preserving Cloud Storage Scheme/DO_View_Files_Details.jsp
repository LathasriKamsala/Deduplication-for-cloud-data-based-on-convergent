...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style29">View Local Machine File's Block Details !!!</h2>
          <p>&nbsp;</p>
                 <%	  
...
int id = Integer.parseInt(request.getParameter("usid"));
			try 
				{
							...
							String quey1="select * from localmachine  where id="+id+" "; 
          ...
          <table width="560" border="0" align="center">
            ...
            <tr>
              <td height="133" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Block-3</strong></strong></span></div></td>
              <td><div align="justify"><span class="style23">
                <textarea name="text1" cols="50" rows="8" readonly="readonly"><%= b1 %></textarea>
              </span> </div></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Hash-Solomon code-3: </strong></strong></span></div></td>
              <td>
