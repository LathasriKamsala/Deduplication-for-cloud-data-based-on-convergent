...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style29">View Cloud File's Block Name !!!</h2>
          <p>&nbsp;</p>
          <%	  
...
try 
	{		
							...
							while( rs1.next())
							{
								...
								s4=rs1.getString(8); // c2
								s5=rs1.getString(10); // dt
          ...
          <table width="586" border="1" style="border-collapse:collapse" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><div align="center" class="style29"><%=s2%></div></td>
            </tr>
            <tr>
              <th height="30" bgcolor="#FF0000" scope="row"><span class="style31">Block1(Hash-Solomon code): </span></th>
              <td bgcolor="#FFFFFF"><div align="center" class="style29"><%=s3%></div></td>
            </tr>
            <tr>
              <th height="30" bgcolor="#FF0000" scope="row"><span class="style31">Block2(Hash-Solomon code): </span></th>
              <td bgcolor="#FFFFFF"><div align="center" class="style29"><%=s4%></div></td>
            </tr>
           
            <tr>
              <th height="30" bgcolor="#FF0000" scope="row"><span class="style31">Date &amp; Time : </span></th>
              <td bgcolor="#FFFFFF"><div align="center" class="style29"><%=s5%></div></td>
            </tr>
            <tr>
              <th height="30" bgcolor="#FF0000" scope="row"><span class="style31">Detailed View : </span></th>
              <td><div align="center" class="style23"><a href="C_View_Files_Details.jsp?usid=<%=j%>">
