...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style29">View Cloud File's Block Details !!!</h2>
          <p>&nbsp;</p>
                 <%	  
...
int id = Integer.parseInt(request.getParameter("usid"));
			try 
				{
							...
							String quey1="select * from cloudserver  where id="+id+" "; 
							...
							if ( rs1.next())
							{
								...
								String sk=rs1.getString(9);
								String dt=rs1.getString(10);
								String fsiz=rs1.getString(11);
								%>
</p>
          <p class="infopost">&nbsp;</p>
          ...
          <table width="560" border="0" align="center">
            ...
            <tr>
              <td height="133" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Block-1 </strong></strong></span></div></td>
              <td><div align="justify"><span class="style23">
                <textarea name="text1" cols="50" rows="8" readonly="readonly"><%= b1 %></textarea>
              </span> </div></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Hash-Solomon code-1: </strong></strong></span></div></td>
              <td>
            ...
            <tr>
              <td height="133" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Block-2 </strong></strong></span></div></td>
              <td><div align="justify"><span class="style23">
                <textarea name="text2" cols="50" rows="8" readonly="readonly"><%= b2 %></textarea>
              </span> </div></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Hash-Solomon code-2: </strong></strong></span></div></td>
              <td>
            ...
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style25"><strong>Secret Key : </strong></span></div></td>
              <td>
            ...
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>Date &amp; Time : </strong></strong></span></div></td>
              <td>
                
                <div align="justify">
                  <input name="t43" type="text" id="t43"
								value="<%= dt %>" size="50" readonly="readonly" />
              </div></td>
            </tr>
            <tr>
              <td height="30" bgcolor="#FF0000"><div align="center" class="style30"><span class="style4 style22"><strong><strong>File Size : </strong></strong></span></div></td>
              <td>
