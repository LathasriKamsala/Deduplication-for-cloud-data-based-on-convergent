...
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style6"> <h1>A Secure Authorized Deduplication Scheme for Cloud Data Based On Blockchain</h1>
    </h1>
      </div>
    </div>
  </div>
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star style5"><strong>Fog Menu</strong></h2>
          <ul class="sb_menu style5">
            <li><strong><a href="C_Main.jsp">Home</a></strong></li>
			<li><strong><a href="F_View_Files_Blocks.jsp">View Files Blocks</a></strong></li>
			<li><strong><a href="F_View_Attackers.jsp">View All Fog User Details</a></strong></li>
