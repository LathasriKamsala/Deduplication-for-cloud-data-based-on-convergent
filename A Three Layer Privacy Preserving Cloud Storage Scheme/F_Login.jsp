...
<div class="main">
  ...
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1>A Three Layer Privacy Preserving Cloud Storage Scheme Based on Computational Intelligence in Fog Computing</h1>
      </div>
    </div>
  </div>
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article style6">
          <h2 class="style5">Fog Server Login </h2>
          <p align="center"><img src="images/Alogin.png" width="256" height="130" /></p>
          <form action="F_Authentication.jsp" method="post" id="leavereply">
