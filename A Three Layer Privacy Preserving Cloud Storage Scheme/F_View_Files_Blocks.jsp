...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style29">View Fog Server File's Block Name !!!</h2>
          <p>&nbsp;</p>
          <%	  
...
try 
	{		
    						...
    						String quey1="select * from fogserver "; 
          ...
          <table width="586" border="1" style="border-collapse:collapse" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <th height="30" bgcolor="#FF0000" scope="row"><span class="style31">Block4(Hash-Solomon code): </span></th>
            ...
            <tr>
              ...
              <td><div align="center" class="style23"><a href="F_View_Files_Details.jsp?usid=<%=j%>">
